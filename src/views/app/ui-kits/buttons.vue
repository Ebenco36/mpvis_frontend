      ...
      <b-col md="6">
        <b-card title="Styles-Button with Icons" class="mb-30">
          <div class="mb-30">
            ...
            <b-button variant="success m-1"> Button </b-button>
      ...
      <b-col md="6">
        ...
        <b-card title="Social" class="mb-30">
          ...
          <div class="ul-bottom__line mb-30">
            ...
            <button
              type="button"
              class="btn round btn-google btn-icon rounded-circle m-1"
            >
              <span class="ul-btn__icon"><i class="i-Google-Plus"></i></span>
            </button>
            <button
            ...
            <button
              type="button"
              class="btn round btn-instagram btn-icon rounded-circle m-1"
            >
              <span class="ul-btn__icon"><i class="i-Instagram"></i></span>
            </button>
            <button
              type="button"
              class="btn round btn-linkedin btn-icon rounded-circle m-1"
            >
              <span class="ul-btn__icon"><i class="i-Linkedin-2"></i></span>
            </button>
            <button
            ...
            <button
              type="button"
              class="btn btn-youtube btn-icon rounded-circle m-1"
            >
              <span class="ul-btn__icon"><i class="i-Youtube"></i></span>
            </button>
          </div>
