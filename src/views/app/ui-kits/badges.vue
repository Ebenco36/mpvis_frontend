        ...
        <b-card title="Sizing & Styles" class="mb-30">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item pl-0 border-0">
              ...
              <b-badge variant="primary badge-round-secondary lg m-1"
                >B</b-badge
              >
            ...
            <li class="list-group-item pl-0 border-0">
              ...
              <b-badge variant="primary badge-square-secondary lg m-1"
                >B</b-badge
              >
            ...
            <li class="list-group-item pl-0 border-0">
              ...
              <b-badge variant="primary badge-round-secondary xl m-1"
                >B</b-badge
              >
            ...
            <li class="list-group-item pl-0 border-0">
              ...
              <b-badge variant="primary badge-square-secondary xl m-1"
                >B</b-badge
              >
        ...
        <b-card title="More Styles & Options" class="mb-30">
          <ul class="list-group list-group-flash">
            ...
            <li class="list-group-item pl-0 border-0">
              ...
              <b-badge variant="primary badge-dark w-badge m-1"
                >Pending</b-badge
              >
              ...
              <b-badge variant="primary badge-warning w-badge m-1"
                >fixed</b-badge
              >
              <b-badge variant="primary badge-info w-badge m-1"
                >in process</b-badge
              >
              <b-badge variant="primary badge-danger w-badge m-1"
                >completed</b-badge
              >
            </li>
            ...
            <li class="list-group-item pl-0 border-0">
              ...
              <b-badge variant="primary badge-dark r-badge m-1"
                >Pending</b-badge
              >
              ...
              <b-badge variant="primary badge-warning r-badge m-1"
                >fixed</b-badge
              >
              <b-badge variant="primary badge-info r-badge m-1"
                >in process</b-badge
              >
              <b-badge variant="primary badge-danger r-badge m-1"
                >completed</b-badge
              >
            </li>
          </ul>
      ...
      <b-col md="6">
        ...
        <b-card title="Unified Styles" class="mb-30">
          <ul class="list-group list-group-flash">
            ...
            <li class="list-group-item pl-0 border-0">
              <b-badge
                variant="primary badge-round  badge-round-opacity-primary  m-1"
                >A</b-badge
              >
              <b-badge
                variant="primary badge-round  badge-round-opacity-secondary  m-1"
                >B</b-badge
              >
              <b-badge
                variant="primary badge-round  badge-round-opacity-success  m-1"
                >C</b-badge
              >
              <b-badge
                variant="primary badge-round  badge-round-opacity-danger  m-1"
                >D</b-badge
              >
              <b-badge
                variant="primary badge-round  badge-round-opacity-warning  m-1"
                >E</b-badge
              >
              <b-badge
                variant="primary badge-round  badge-round-opacity-info  m-1"
                >F</b-badge
              >
              <b-badge
                variant="primary badge-round  badge-round-opacity-dark  m-1"
                >G</b-badge
              >
            </li>
            ...
            <li class="list-group-item pl-0 border-0">
              <b-badge
                variant="primary badge-square  badge-square-opacity-primary  m-1"
                >A</b-badge
              >
              <b-badge
                variant="primary badge-square  badge-square-opacity-secondary  m-1"
                >B</b-badge
              >
              <b-badge
                variant="primary badge-square  badge-square-opacity-success  m-1"
                >C</b-badge
              >
              <b-badge
                variant="primary badge-square  badge-square-opacity-danger  m-1"
                >D</b-badge
              >
              <b-badge
                variant="primary badge-square  badge-square-opacity-warning  m-1"
                >E</b-badge
              >
              <b-badge
                variant="primary badge-square  badge-square-opacity-info  m-1"
                >F</b-badge
              >
              <b-badge
                variant="primary badge-square  badge-square-opacity-dark  m-1"
                >G</b-badge
              >
            </li>
          </ul>
        ...
        <b-card class="mb-30" title="Basic Examples">
          <ul class="list-group list-group-flash">
            ...
            <li class="list-group-item pl-0 border-0">
              ...
              <b-badge variant="badge  badge-round-success pill  m-1"
                >HOT</b-badge
              >
              <b-badge variant="badge  badge-round-primary pill m-1"
                >NEW</b-badge
              >
        ...
        <b-card title="Outline Badges" class="mb-30">
          <ul class="list-group list-group-flash">
            ...
            <li class="list-group-item pl-0 border-0">
              ...
              <b-badge variant="badge outline-round-secondary sm m-1"
                >B</b-badge
              >
