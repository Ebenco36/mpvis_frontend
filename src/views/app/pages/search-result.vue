        ...
        <b-col md="12">
          <div class="ul-search-result__bar mb-30">
            ...
            <small class="text-muted"
              >About {{ filterSearch.length }} result ( 0.20 seconds)</small
            >
          </div>
      ...
      searchList: [
        {
          ...
          text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, minima autem quam exercitationem eos, obcaecati aperiam delectus quia sapiente, deserunt quis atque dolorem ducimus recusandae perspiciatis mollitia excepturi ea rerum?",
        },
        {
          id: 2,
          title: "React.js",
