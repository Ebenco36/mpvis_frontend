<template>
  <div class="main-content">
    ...
    <b-row>
        ...
        <b-card class="" title="Work List">
          <div class="ul-widget-app__task-list mb-4">
            <label class="checkbox checkbox-primary">
              ...
              >
              <b-badge pill variant="danger" class="p-2 float-right"
                >Today</b-badge
              >
            ...
            <div class="ul-widget-app__work-list-img ml-4">
              <img
                class="profile-picture avatar-sm rounded-circle mr-1"
          ...
          <div class="ul-widget-app__task-list mb-4">
            <label class="checkbox checkbox-primary">
              ...
              <span
                >Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span
              >
              <b-badge pill variant="success" class="p-2 float-right"
                >Tomorrow</b-badge
              >
              <span class="checkmark"></span>
            </label>
          ...
          <div class="ul-widget-app__task-list mb-4">
            <label class="checkbox checkbox-primary">
              ...
              <span
                >Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span
              >
              <b-badge pill variant="info" class="p-2 float-right"
                >Yestarday</b-badge
              >
              <span class="checkmark"></span>
            </label>
          ...
          <div class="ul-widget-app__task-list mb-4">
            <label class="checkbox checkbox-primary">
              ...
              <span
                >Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span
              >
              <b-badge pill variant="warning" class="p-2 float-right"
                >Week</b-badge
              >
              <span class="checkmark"></span>
            </label>
          ...
          <div class="ul-widget-app__task-list mb-4">
            <label class="checkbox checkbox-primary">
              ...
              <span
                >Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span
              >
              <b-badge pill variant="primary" class="p-2 float-right"
                >Week</b-badge
              >
              <span class="checkmark"></span>
            </label>
      ...
      <b-col lg="4" md="6" class="mb-30">
        <b-card title="Developer Total Earning" class="">
        ...
        <b-card no-body class="">
          <b-card-header class="purple-500 text-purple-500 p-4">
            ...
            <div class="input-group input-group-lg">
              ...
              />
              <span class="ul-widget-app__find-font"
                ><i class="i-Search-People font-weight-500"></i
              ></span>
            </div>
          </b-card-header>
          <b-card-body>
            <div class="ul-widget-app__social-site mt-4 mb-30">
              ...
              <div class="ul-widget-app__social-button mt-5">
                <button
                  type="button"
                  class="btn btn-block btn-facebook btn-icon m-1"
                >
                ...
                <button
                  type="button"
                  class="btn btn-block btn-twitter btn-icon m-1"
                >
      ...
      <b-col lg="4" md="6" class="mb-30">
        <b-card title="Notification" class="">
          <div class="ul-widget-app__browser-list">
            <div class="ul-widget-app__browser-list-1 mb-30">
              <i
                class="i-Bell1 text-white bg-warning rounded-circle p-2 mr-3"
              ></i>
            ...
            <div class="ul-widget-app__browser-list-1 mb-30">
              <i
                class="i-Internet text-white green-500 rounded-circle p-2 mr-3"
              ></i>
            ...
            <div class="ul-widget-app__browser-list-1 mb-30">
              <i
                class="i-Shopping-Cart text-white cyan-500 rounded-circle p-2 mr-3"
              ></i>
            ...
            <div class="ul-widget-app__browser-list-1 mb-30">
              <i
                class="i-Add-UserStar text-white teal-500 rounded-circle p-2 mr-3"
              ></i>
            ...
            <div class="ul-widget-app__browser-list-1 mb-30">
              <i
                class="i-Bell text-white purple-500 rounded-circle p-2 mr-3"
              ></i>
            ...
            <div class="ul-widget-app__browser-list-1 mb-30">
              <i
                class="i-Shopping-Cart text-white bg-danger rounded-circle p-2 mr-3"
              ></i>
              <span class="text-15">New Order Received</span>
              <span class="text-mute">yesterday </span>
            </div>
            ...
            <div class="timeline timeline--align">
              <div class="timeline-item mt-0">
                <div class="timeline-badge">
                  <i
                    class="badge-icon bg-danger text-white i-Arrow-Refresh"
                  ></i>
                </div>
              </div>
            </div>
      ...
      <b-col lg="4" md="6" class="mb-30">
        <b-card title="Poll" class="">
          <div class="ul-widget-app__header mb-30">
            ...
            <h6 class="text-mute font-weight-600">
              Your mobile app daily usage
            </h6>
          </div>
          <b-form-radio name="some-radios" class="mb-3" value="A"
            >A 20 minutes</b-form-radio
          >
          <b-form-radio name="some-radios" class="mb-3" value="B"
            >B More than 30 minutes</b-form-radio
          >
          <b-form-radio name="some-radios" class="mb-3" value="C"
            >C 1 Hour</b-form-radio
          >
        </b-card>
      </b-col>
        ...
        <b-card>
          <div class="user-profile mb-30">
            <div class="ul-widget-card__user-info border-bottom-gray-200 pb-3">
              <img
                class="profile-picture avatar-xl mb-2"
                src="@/assets/images/faces/4.jpg"
                alt=""
              />
            ...
            <div class="ul-widget-app__profile-footer mt-4">
              ...
              <div class="ul-widget-app__profile-footer-font">
                <a href="">
                  <i
                    class="i-File-Clipboard-File--Text text-16 font-weight-600 mr-1"
                  ></i>
      ...
      <b-col lg="4" md="6" class="mb-30">
        <b-card title="Feedback" class="">
          ...
          <div class="ul-widget-app__work-list-img mt-4">
            <img
              class="profile-picture avatar-md rounded-circle mr-1"
              src="@/assets/images/faces/4.jpg"
              alt=""
            />
            <img
...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {
          developer: require("@/assets/images/faces/4.jpg"),
          name: "Lucy ",
          priority: "Gull Admin",
          Budget: "$4.9K",
        },
        {
          developer: require("@/assets/images/faces/2.jpg"),
          name: "Lucy ",
          priority: "Agency",
          Budget: "$70K",
        },
        {
          developer: require("@/assets/images/faces/1.jpg"),
          name: "Dan ",
          priority: "Developer",
          Budget: "$70K",
        },
        {
          developer: require("@/assets/images/faces/3.jpg"),
          name: "Jack",
          priority: "Designer",
          Budget: "$70K",
        },
        {
          developer: require("@/assets/images/faces/5.jpg"),
          name: "Clarkson",
          priority: "Programmer",
          Budget: "$70K",
        },
