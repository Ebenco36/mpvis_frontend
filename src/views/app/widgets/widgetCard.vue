          ...
          <div class="card-img-overlay">
            ...
            <div class="p-1 text-left card-footer font-weight-light d-flex">
              <span class="mr-3 d-flex align-items-center"
                ><i class="i-Speach-Bubble-6 mr-1"></i> 12
              </span>
        ...
        <b-card title="Timeline">
          <div class="ul-widget-s6__items ul-widget-card__position">
            <div class="ul-widget-card__item">
              <span class="ul-widget-s6__badge ul-widget-card__dot">
                <p
                  class="badge-dot-primary ul-widget6__dot ul-widget-card__dot-xl"
                >
          ...
          <div class="ul-widget-s6__items ul-widget-card__position">
            <div class="ul-widget-card__item">
              <span class="ul-widget-s6__badge ul-widget-card__dot">
                <p
                  class="badge-dot-success ul-widget6__dot ul-widget-card__dot-xl"
                >
          ...
          <div class="ul-widget-s6__items ul-widget-card__position">
            <div class="ul-widget-card__item">
              <span class="ul-widget-s6__badge ul-widget-card__dot">
                <p
                  class="badge-dot-danger ul-widget6__dot ul-widget-card__dot-xl"
                >
