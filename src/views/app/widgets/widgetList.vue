          ...
          <div class="ul-widget__body">
            <div class="__g-widget4">
              <div class="ul-widget__item">
                ...
                <a href="#" class="ul-widget4__title"> Documentation </a>
              </div>
              ...
              <div class="ul-widget__item">
                ...
                <a href="#" class="ul-widget4__title"> Project Launch Event </a>
              </div>
            </div>
          </div>
        </b-card>
          ...
          <div class="ul-widget__body">
            <div class="ul-widget1">
              <div class="ul-widget__item ul-widget4__users">
                ...
                <div class="ul-widget2__info ul-widget4__users-info">
                  <a href="#" class="ul-widget4__title"> New Version </a>
                </div>
                <span class="ul-widget4__number t-font-boldest text-success"
                  >+500</span
                >
              ...
              <div class="ul-widget__item ul-widget4__users">
                ...
                <div class="ul-widget2__info ul-widget4__users-info">
                  <a href="#" class="ul-widget4__title"> Old Version </a>
                </div>
              ...
              <div class="ul-widget__item ul-widget4__users">
                ...
                <div class="ul-widget2__info ul-widget4__users-info">
                  <a href="#" class="ul-widget4__title"> Old Version 2 </a>
                </div>
                <span class="ul-widget4__number t-font-boldest text-warning"
                  >+333</span
                >
          ...
          <div class="ul-widget5">
            <div class="ul-widget-s5__item mb-5">
              <div class="ul-widget-s5__content">
                ...
                <div class="ul-widget-s5__section">
                  <a href="#" class="ul-widget4__title"> Great Logo Designn </a>
            ...
            <div class="ul-widget-s5__item mb-5">
              ...
              <div class="ul-widget-s5__content">
                ...
                <b-button variant="outline-success"> Follow </b-button>
              </div>
            </div>
            <div class="ul-widget-s5__item mb-5">
              <div class="ul-widget-s5__content">
                ...
                <div class="ul-widget-s5__section">
                  <a href="#" class="ul-widget4__title"> Frontend Developer </a>
                  <p class="ul-widget-s5__desc">UI LIb admin themes.</p>
                </div>
              </div>
              <div class="ul-widget-s5__content">
                ...
                <b-button variant="outline-danger"> Follow </b-button>
              </div>
            </div>
          </div>
        </b-card>
